...
public class BuffGrassTest {
    ...
    public void DefaultGrassInteraction() {
        ...
        field.cell(3, 4).putUnit(new Grass(new StrengthBuffEffect(2, 5)));
        g.Interact();
        Assertions.assertEquals(g.getStrength(), 2);
        Assertions.assertEquals(g.getEffect().getBuffStrength(), 5);
    }
    ...
    public void CustomGrassInteraction() {
        ...
        field.cell(3, 4).putUnit(new Grass(new StrengthBuffEffect(100, 100)));
        g.Interact();
        Assertions.assertEquals(g.getStrength(), 100);
        Assertions.assertEquals(g.getEffect().getBuffStrength(), 100);
    }
    ...
    public void GrassBuffProcess() {
        ...
        field.cell(3, 4).putUnit(new Grass(new StrengthBuffEffect(3, 4)));
        g.Interact();
        g.Sleep(4);
        Assertions.assertEquals(g.getStrength(), 1);
        Assertions.assertEquals(g.getEffect().getBuffStrength(), 0);
    }
